...
void CGameControllerKDOM::OnCapture(int SpotNumber, int Team, int NumOfCapCharacters, CCharacter* apCapCharacters[MAX_PLAYERS])
{
	CGameControllerDOM::OnCapture(SpotNumber, Team, NumOfCapCharacters, apCapCharacters);
